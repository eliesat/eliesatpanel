...
def main(session, **kwargs):
    ...
    "سيستمر تحديث إضافات البانل كما هي بعد هذا التاريخ.\n\n"
"●النسخة الجديدة محدثة بآخر الاضافات و تتضمن خدمات اضافية.\n\n"
  "●النسخة الجديدة مخصصة للمشتركين عن طريقنا بإحدى خدمات الـ اي بي تي في. للحصول عليها:\n\n"
