...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Ciefp-motor"), 5, _("ملف قنوات 14.12.2024"), e))
		...
		self.list.append((_("Mohamed-os-motor"), 9, _("ملف قنوات 01.01.2025"), i))
		self.list.append((_("Mohgooda-motor"), 10, _("ملف قنوات 09.08.2024"), j))
		self.list.append((_("Morpheus883-motor"), 11, _("ملف قنوات 09.10.2024"), k))
		...
		self.list.append((_("Vhannibal-motor"), 15, _("ملف قنوات 05.01.2025"), o))
		self.list.append((_("Freq-Eliesat"), 16, _("ملف ترددات 21.10.2024"), p))
		self.list.append((_("Freq-flysat"), 17, _("ملف ترددات 18.12.2024"), q))
		self.list.append((_("Freq-Lyngsat"), 18, _("ملف ترددات 05.01.2025"), r))
		self.list.append((_("Freq-Oe-alliance"), 19, _("محدث تلقائيا"), s))
		self.list.append((_("Freq-Openpli"), 20, _("محدث تلقائيا"), t))
