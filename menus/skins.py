...
<!-- title1 -->
<eLabel text="Skins" position="1520,700" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Aglare-fhd-5.0"), 1, _("egami-openatv-openspa-pure2"), a))
		...
		self.list.append((_("Xdreamy-fhd-5.1.0"), 21, _("all"), u))
