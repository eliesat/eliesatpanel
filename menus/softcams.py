...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Oscam-11866-r802"), 6, _("mohamed-os •ipk•deb"), f))
		self.list.append((_("Gosatplus-oscam-11866-r802"), 7, _("mohamed-os"), g))
		self.list.append((_("Powercam-oscam-11866-r802"), 8, _("mohamed-os"), h))
		self.list.append((_("Supcam-oscam-11866-r802"), 9, _("mohamed-os"), i))
		self.list.append((_("Ultracam-oscam-11866-r802"), 10, _("mohamed-os"), j))
		self.list.append((_("Ncam-15.2"), 11, _("fairbird •ipk•deb"), k))
		self.list.append((_("Oscamicamnew-11863-r802"), 12, _("kite888 •ipk•deb"), l))
		self.list.append((_("Oscam-11866-emu-r802"), 13, _("audi06 •ipk •deb"), m))
		self.list.append((_("Oscam-11866-emu-r802"), 14, _("levi45 •ipk •deb"), n))
