...
class feeds(Screen):
	skin = """
<screen name="feeds" position="0,0" size="1920,1080" backgroundColor="transparent" flags="wfNoBorder" title="ElieSatPanel">
...
<!-- title -->
<eLabel text="Feeds" position="160,120" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<!-- title1 -->
<eLabel text="Feeds" position="1540,700" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Eliesat"), 1, _("فيد تسطيب اضافات"), a))
		self.list.append((_("Emil"), 2, _("فيد تسطيب اضافات"), b))
		self.list.append((_("Jungle"), 3, _("فيد اسباني تسطيب اضافات"), c))
		self.list.append((_("Oe-alliance-picons"), 4, _("فيد بيكونات اضافي snp srp"), d))
		self.list.append((_("Oe-alliance-settings"), 5, _("فيد ملفات قنوات"), e))
		self.list.append((_("Openpicons"), 6, _("فيد بيكونات اضافي snp srp"), f))
		self.list.append((_("Softcams-feed-openatv"), 7, _("فيد ايميوهات صورة openatv"), g))
		self.list.append((_("Softcams-feed-pure2"), 8, _("فيد ايميوهات صورة pure2"), h))
		self.list.append((_("Tarek"), 9, _("فيد تسطيب اضافات"), i))
	...
	def select_item(self, item):
		if item:
            ...
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/eliesat-feed.sh -qO - | /bin/sh"
        ])
			elif item is 2:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/emil-feed.sh -qO - | /bin/sh"
        ])
			elif item is 3:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/jungle-feed.sh -qO - | /bin/sh"
        ])
			elif item is 4:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/oe-picons-feed.sh -qO - | /bin/sh"
        ])
			elif item is 5:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/oe-settings-feed.sh -qO - | /bin/sh"
        ])
			elif item is 6:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/openpicons-feed-.sh -qO - | /bin/sh"
        ])
			elif item is 7:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/openatv-softcam-feed.sh -qO - | /bin/sh"
        ])
			elif item is 8:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/pure2-softcam-feed.sh -qO - | /bin/sh"
        ])
			elif item is 9:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/scripts/-/raw/main/feed/tarek-feed.sh -qO - | /bin/sh"
        ])
