...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("E2m3ubouquet-2.0.0"), 28, _("تحويل الiptv لمفضلات mod-dorik"), B))
		...
		self.list.append((_("Wireguard-vpn-14.9"), 100, _("اضافة اشتراك الvpn + معاينة سرعة النت"), pV))
		self.list.append((_("Worldcam-4.7"), 101, _("كاميرات من حول العالم"), pW))
		self.list.append((_("Xcplugin-forever-4.0"), 102, _("مشغل اي بي تي في"), pX))
		self.list.append((_("Xklass-1.35"), 103, _("مشغل اي بي تي في"), pY))
		self.list.append((_("Xstreamity-4.78"), 104, _("مشغل اي بي تي في"), pZ))
