...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("E2m3ubouquet-2.0.2"), 28, _("تحويل الiptv لمفضلات mod-dorik"), B))
		self.list.append((_("Enigma2readeradder-2.0"), 113, _("كتابة سطر السسكام و تعريفه داخل الايميوهات"), i))
		...
		self.list.append((_("Subssupport-1.7.0-r15"), 91, _("الترجمة"), pM))
		...
		self.list.append((_("Xtraevent-6.806"), 107, _("جلب بوسترات يعمل على السكينات الخاصة فيه"), ac))
