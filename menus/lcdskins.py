...
class lcdskins(Screen):
	skin = """
<screen name="lcdskins" position="0,0" size="1920,1080" backgroundColor="transparent" flags="wfNoBorder" title="ElieSatPanel">
...
<!-- title -->
<eLabel text="Lcdskins" position="160,120" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<!-- title1 -->
<eLabel text="Lcdskins" position="1520,700" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Lcdskin1"), 1, _("سكين شاشة vu+ uno 4k se"), a))
		self.list.append((_("Lcdskin2"), 2, _("سكين شاشة vu+ uno 4k se"), b))
		self.list.append((_("Lcdskin3"), 3, _("سكين شاشة vu+ uno 4k se"), c))
		self.list.append((_("Lcdskin4"), 4, _("سكين شاشة vu+ uno 4k se"), d))
		self.list.append((_("Lcdskin5"), 5, _("سكين شاشة vu+ uno 4k se"), e))
		self.list.append((_("Lcdskin6"), 6, _("سكين شاشة vu+ uno 4k se"), f))
		self.list.append((_("Lcdskin7"), 7, _("سكين شاشة vu+ uno 4k se"), g))
		self.list.append((_("Lcdskin8"), 8, _("سكين شاشة vu+ uno 4k se"), h))
		self.list.append((_("Lcdskin9"), 9, _("سكين شاشة vu+ uno 4k se"), i))
		self.list.append((_("Lcdskin10"), 10, _("سكين شاشة vu+ uno 4k se"), j))
		self.list.append((_("Lcdskin11"), 11, _("سكين شاشة vu+ uno 4k se"), k))
		self.list.append((_("Lcdskin12"), 12, _("سكين شاشة vu+ uno 4k se"), l))
		self.list.append((_("Lcdskin13"), 13, _("سكين شاشة vu+ uno 4k se"), m))
		self.list.append((_("Splash-image"), 14, _("صورة للشاشة الامامية الخاصة باجهزة الvu+"), n))
	...
	def select_item(self, item):
		if item:
            ...
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/openatv-neutral/openatv.sh -qO - | /bin/sh"
				...
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-2.sh -qO - | /bin/sh"
        ])
			elif item is 3:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-3.sh -qO - | /bin/sh"
        ])
			elif item is 4:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-4.sh -qO - | /bin/sh"
        ])
			elif item is 5:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-5.sh -qO - | /bin/sh"
        ])
			elif item is 6:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-.sh -qO - | /bin/sh"
        ])
			elif item is 7:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-7.sh -qO - | /bin/sh"
        ])
			elif item is 8:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-8.sh -qO - | /bin/sh"
        ])
			elif item is 9:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-9.sh -qO - | /bin/sh"
        ])
			elif item is 10:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-10.sh -qO - | /bin/sh"
        ])
			elif item is 11:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-11.sh -qO - | /bin/sh"
        ])
			elif item is 12:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-12.sh -qO - | /bin/sh"
        ])
			elif item is 13:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/lcdskin/lcdskin-13.sh -qO - | /bin/sh"
        ])
			elif item is 14:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/display/-/raw/main/splash/splash.sh -qO - | /bin/sh"
        ])
