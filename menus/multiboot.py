...
class multiboot(Screen):
	skin = """
<screen name="multiboot" position="0,0" size="1920,1080" backgroundColor="transparent" flags="wfNoBorder" title="ElieSatPanel">
...
<!-- title -->
<eLabel text="Multiboot" position="160,120" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<!-- title1 -->
<eLabel text="Multiboot" position="1510,700" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Barryallen-12.91-r1"), 1, _("تسطيب صور خام على الذاكرة الخارجية"), a))
		self.list.append((_("Egamiboot-10.6"), 2, _("تسطيب صور خام على الذاكرة الخارجية"), b))
		self.list.append((_("Image-downloader-2.6"), 3, _("تنزيل صور خام على الذاكرة الخارجية py2"), c))
		self.list.append((_("Meoboot-0.1"), 4, _("تسطيب صور على الذاكرة الخارجية"), d))
		self.list.append((_("Multiboot-flashonline-7.1"), 5, _("تنزيل و تسطيب صور على الذاكرة الخارجية"), e))
		self.list.append((_("Nfr4xboot-2.0"), 6, _("تسطيب صور على الذاكرة الخارجية"), f))
		self.list.append((_("Neoboot-2.05"), 7, _("تسطيب صور على الذاكرة الخارجية"), g))
		self.list.append((_("Neoboot-5.8"), 8, _("تسطيب صور على الذاكرة الخارجية"), h))
		self.list.append((_("Neoboot-8.20"), 9, _("تسطيب صور على الذاكرة الخارجية"), i))
		self.list.append((_("Neoboot-9.11"), 10, _("تسطيب صور على الذاكرة الخارجية"), j))
		self.list.append((_("Neoboot-9.32"), 11, _("تسطيب صور على الذاكرة الخارجية mod linuxsat"), k))
		self.list.append((_("Neoboot-9.36"), 12, _("تسطيب صور على الذاكرة الخارجية mod linuxsat"), l))
		self.list.append((_("Neoboot-9.54"), 13, _("تسطيب صور على الذاكرة الخارجية mod linuxsat"), m))
		self.list.append((_("Neoboot-9.58"), 14, _("تسطيب صور على الذاكرة الخارجية mod elsafty"), n))
		self.list.append((_("Neoboot-9.60"), 15, _("تسطيب صور على الذاكرة الخارجية mod linuxsat"), o))
		self.list.append((_("Neoboot-9.62"), 16, _("تسطيب صور على الذاكرة الخارجية mod linuxsat mips"), p))
		self.list.append((_("Neoboot-9.65"), 17, _("تسطيب صور على الذاكرة الخارجية"), q))
		self.list.append((_("Neoboot-duo4k-5.3"), 18, _("تسطيب صور على الذاكرة الخارجية"), r))
		self.list.append((_("Neoboot-e2turk-3.9.1"), 19, _("تسطيب صور على الذاكرة الخارجية"), s))
		self.list.append((_("Opdboot-3.1"), 20, _("تسطيب صور على الذاكرة الخارجية py3.11"), t))
		self.list.append((_("Openmultiboot-1.0"), 21, _("تسطيب صور على الذاكرة الخارجية"), u))
	...
	def select_item(self, item):
		if item:
            ...
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/barryallen/barryallen.sh -qO - | /bin/sh"
        ])
			elif item is 2:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/egamiboot/egamiboot.sh -qO - | /bin/sh"
        ])
			elif item is 3:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/image-downloader/image-downloader.sh -qO - | /bin/sh"
        ])
			elif item is 4:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/meoboot/meoboot.sh -qO - | /bin/sh"
        ])
			elif item is 5:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/multiboot-flashonline/multiboot-flashonline.sh -qO - | /bin/sh"
        ])
			elif item is 6:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/nfr4xboot/nfr4xboot.sh -qO - | /bin/sh"
        ])
			elif item is 7:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-2.05.sh -qO - | /bin/sh"
        ])
			elif item is 8:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-5.8.sh -qO - | /bin/sh"
        ])
			elif item is 9:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-8.20.sh -qO - | /bin/sh"
        ])
			elif item is 10:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.11.sh -qO - | /bin/sh"
        ])
			elif item is 11:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.32.sh -qO - | /bin/sh"
        ])
			elif item is 12:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.36.sh -qO - | /bin/sh"
        ])
			elif item is 13:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.54.sh -qO - | /bin/sh"
        ])
			elif item is 14:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.58-r3.sh -qO - | /bin/sh"
        ])
			elif item is 15:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.60.sh -qO - | /bin/sh"
        ])
			elif item is 16:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.62.sh -qO - | /bin/sh"
        ])
			elif item is 17:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-9.65.sh -qO - | /bin/sh"
        ])
			elif item is 18:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-duo4k.sh -qO - | /bin/sh"
        ])
			elif item is 19:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/neoboot/neoboot-e2turk.sh -qO - | /bin/sh"
        ])
			elif item is 20:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/opdboot/opdboot.sh -qO - | /bin/sh"
        ])
			elif item is 21:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/extensions/-/raw/main/openmultiboot/openmultiboot.sh -qO - | /bin/sh"
        ])
