...
class drivers(Screen):
	skin = """
<screen name="drivers" position="0,0" size="1920,1080" backgroundColor="transparent" flags="wfNoBorder" title="ElieSatPanel">
...
<!-- title -->
<eLabel text="Drivers" position="160,120" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<!-- title1 -->
<eLabel text="Drivers" position="1520,700" size="400,50" zPosition="1" font="Regular;40" halign="left" foregroundColor="white" backgroundColor="#ff2c2d2b" transparent="1" />
...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Kernel-nandsim-zgemmah7s"), 1, _("تعريف خاص بال openmultiboot"), a))
		self.list.append((_("Kernel-nandsim-zgemmah9s"), 2, _("تعريف خاص بال openmultiboot"), b))
		self.list.append((_("Wifi-usb-mt7601u-1.0-r0"), 3, _("تعريف خاص بالواي فاي يو اس بس"), c))
		self.list.append((_("Wifi-usb-mt7601u-1.0-r2"), 4, _("تعريف خاص بالواي فاي يو اس بس"), d))
		self.list.append((_("Wifi-usb-novaler"), 5, _("تعريف خاص بالواي فاي يو اس بس"), e))
		self.list.append((_("Wifi-usb-rt3070-1.0-r0"), 6, _("تعريف خاص بالواي فاي يو اس بس"), f))
		self.list.append((_("Wifi-usb-rt3573-1.0-r0"), 7, _("تعريف خاص بالواي فاي يو اس بس"), g))
		self.list.append((_("Wifi-usb-zgemmah7s"), 8, _("تعريف خاص بالواي فاي يو اس بس"), h))
	...
	def select_item(self, item):
		if item:
            ...
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/kernel-module-nandsim-h9.sh -qO - | /bin/sh"
        ])
			elif item is 2:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/kernel-module-nandsim-h9.sh -qO - | /bin/sh"
				...
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/network-usb-mt7610u-1.0-r0.ipk -qO - | /bin/sh"
        ])
			elif item is 4:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/network-usb-mt7601u-1.0-r2.sh -qO - | /bin/sh"
        ])
			elif item is 5:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/network-usb-novaler-1.0.sh -qO - | /bin/sh"
        ])
			elif item is 6:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/network-usb-rt3070-1.0-r0.sh -qO - | /bin/sh"
        ])
			elif item is 7:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/network-usb-rt3573-1.0-r0.sh -qO - | /bin/sh"
        ])
			elif item is 8:
				self.session.open(Console, _("Installing package please wait..."), [
            "wget --no-check-certificate https://gitlab.com/eliesat/drivers/-/raw/main/network-usb-zgemmah7-1.0.sh -qO - | /bin/sh"
        ])
