...
<ePixmap position="1530,870" size="140,60" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/images/info.png" zPosition="2" alphatest="blend" />
	...
	def mList(self):
		...
		self.list.append((_("Ajpanel-10.7.0"), 1, _("ادارة الملفات و مجموعة كبيرة من الخدمات"), a))
		...
		self.list.append((_("Levi45addonmanager-10.2-r0"), 5, _("بانل تسطيب اضافات"), e))
		self.list.append((_("Levi45multicammanager-10.1-r38"), 6, _("بانل تسطيب كامات و سكريبتات مختلفة"), f))
		self.list.append((_("Linuxsat-panel-2.7.7"), 7, _("بانل تسطيب اضافات"), g))
